...
set rc [catch {
  ...
  set_property ip_repo_paths e:/CPU/CPU.cache/ip [current_project]
  set_property ip_output_repo e:/CPU/CPU.cache/ip [current_project]
  add_files -quiet E:/CPU/CPU.runs/synth_1/CPU.dcp
